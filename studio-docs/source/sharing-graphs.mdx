...
A URI-encoded, stringified object containing initial variable values to populate in the Explorer on load.
...
A URI-encoded, stringified object containing initial HTTP header values to populate in the Explorer on load.
