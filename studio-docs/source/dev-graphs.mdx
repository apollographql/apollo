...
sidebar_title: Local development (dev graphs)
description: Use Studio features in your development environment
---

Development graphs (or **dev graphs**) are a special type of graph in Apollo Studio. Unlike a _deployed_ graph (which represents your data graph in deployed environments like staging and production), a dev graph represents your data graph in your own development environment. It's only visible to you, and because it's separate from your deployed graph, you can quickly and safely iterate on its schema without affecting other clients.

Dev graphs provide the subset of Studio features that are most useful for development, specifically:

* [The Apollo Studio Explorer](./explorer/)
* Schema changelog

Among other Studio features, dev graphs do _not_ currently support:

* [Variants](./org/graphs/#managing-variants)
* Metrics reporting
* Graph API keys
...
You can use the [Apollo Studio Explorer](./explorer) to explore and query dev graphs just like you use it with deployed graphs.
