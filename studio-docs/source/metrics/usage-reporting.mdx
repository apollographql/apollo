...
Apollo Studio can ingest operation traces from your GraphQL server to provide performance metrics for your graph:

<img src="../img/studio-metrics.jpg" class="screenshot" alt="Apollo Studio metrics view" />
