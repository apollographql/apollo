...
This document specifies the protocol that any GraphQL server can implement to enable automatic [schema registration](./schema/schema-reporting/) with the Apollo schema registry.
