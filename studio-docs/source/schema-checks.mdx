...
> If your data graph uses Apollo Federation, see [checking changes to a federated graph](https://www.apollographql.com/docs/federation/managed-federation/advanced-topics/#checking-changes-to-a-federated-graph) instead of this article.
