...
* Only organization members with the [`Graph Admin` role](./org/members/#organization-wide-member-roles) can _create or edit_ a variant's preflight script.
...
1. [Open Apollo Studio](https://studio.apollographql.com/org/gh.StephenBarlow) and then open the Explorer for the graph and variant you want to create a script for.
