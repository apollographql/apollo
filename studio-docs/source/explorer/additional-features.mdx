...
As you edit your operation, the Explorer recalculates the example query plan accordingly.

> **⚠️ The Explorer might not always calculate the exact same query plan as your gateway!** The Explorer's example query plan helps you reason about your operations, but it is _not_ intended as a source of truth.
