...
Just like any other graph in Studio, a federated graph can have multiple [variants](./org/graphs/#managing-variants). Each variant has its own schema, change history, and metrics.
