...
<img class="screenshot" src="./img/federated-graphs/subgraph-contact-info-on-sdl.jpg" width="736" />
...
<img class="screenshot" src="./img/federated-graphs/federated-graph-composition-error-modal.jpg" width="736" />
