...
# All fields on the "Product" object inherit the "partner" tag so we can avoid tagging them explicitly
...
* You can apply tags to the following in your schema:
    ...
    * Tags on an object or interface are inherited by all of its fields (as shown above)
