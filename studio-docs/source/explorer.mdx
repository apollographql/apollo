...
The bottom of the Explorer editor includes a Environment Variables section so you can set sensitive information to be sent with your operation's HTTP request.
...
> **WARNING:** Default Headers should not be used to store sensitive information. Users should use the **Environment Variables** pane to set these.
