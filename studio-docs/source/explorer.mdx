...
* **In Sandbox**, edit your connection settings and disable **Auto Update**.
* **In dev graphs**, open the **DEV GRAPH** menu at the top and disable **Auto Update**.

### Embedding

If you've enabled [public access to a variant of your graph](./sharing-graphs/#public-graph-access), you can embed the Explorer in a webpage that you can then provide to your graph's consumers. This enables those consumers to test out operations from your own website.
