...
**Apollo Sandbox** is a special instance of the Explorer that doesn't require an Apollo account. It doesn't support advanced features like schema history, but it's great for local development.
