...
You can create additional organizations by clicking the `+` button at the top of your list of organizations in [Studio](https://engine.apollographql.com). A single Studio organization can include any number of [graphs](./org-graphs/), so a company rarely needs more than one or two organizations.
