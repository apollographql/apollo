---
title: Pushing metrics to Apollo Studio
sidebar_title: Setup
...
You can set up a reporting agent in your GraphQL server to push analytics to Apollo Studio. The agent is responsible for:
