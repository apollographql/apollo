...
Graph Manager provides core GraphQL schema management features to all users for free, along with advanced security, validation, and integration features to organizations with an [Apollo Team or Enterprise plan](https://www.apollographql.com/pricing).
