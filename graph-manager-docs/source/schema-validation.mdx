...
> Schema validation is available as part of [Team and Enterprise plans](https://www.apollographql.com/plans/).
...
2. [Set up schema registration in your continuous delivery pipeline](/schema-registry/)
