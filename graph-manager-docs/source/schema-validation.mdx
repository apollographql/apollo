...
If your data graph uses [Apollo Federation](/federation-advanced/#validating-changes-to-the-graph), the schema validation process differs slightly.

For details, see [Validating changes to the graph](/federation-advanced/#validating-changes-to-the-graph).
