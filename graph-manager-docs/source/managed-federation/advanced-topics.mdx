...
Whenever possible, you should update your service configuration in a way that is backward compatible to avoid downtime. The single best way to do this is to minimize the number of [breaking changes](../schema-validation/#potentially-breaking-changes) you make to your schemas.
