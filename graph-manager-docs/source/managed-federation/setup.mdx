...
Like your implementing services, your gateway uses an API key to identify itself to Studio. Obtain a **graph API key** from your graph's Settings page in [Studio](https://engine.apollographql.com/).
