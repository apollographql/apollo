...
1. Visit [engine.apollographql.com](https://engine.apollographql.com/) again. Now that you're logged in, this opens Studio.
...
The best way to familiarize yourself with Studio's capabilities is to explore it! Visit [engine.apollographql.com](https://engine.apollographql.com/) and check out the various views and what they provide.
