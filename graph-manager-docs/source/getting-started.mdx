...
> If you are using [Apollo Federation](https://www.apollographql.com/docs/apollo-server/federation/introduction/), get started with [Managing a federated graph](./federation/) instead of this article.

## Prerequisites

Before you begin, make sure that you have an application that uses Apollo Server as its GraphQL server.

If you don't have one, first [get started with Apollo Server](https://www.apollographql.com/docs/apollo-server/getting-started/).
