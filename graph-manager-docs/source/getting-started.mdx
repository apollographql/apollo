...
In Studio, each **graph** corresponds to the entirety of a GraphQL schema. Your first graph will correspond to your GraphQL server's schema.
...
3. Specify a name for your graph and click **Next**. Studio displays a list of instructions, which are also described in the [next section](#step-3-configure-your-project).
