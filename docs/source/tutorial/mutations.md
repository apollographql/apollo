...
**Note:** Get the [`components/page-container` code from GitHub.](https://github.com/apollographql/fullstack-tutorial/blob/client/client/src/components/page-container.js)
