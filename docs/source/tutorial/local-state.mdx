...
To add a virtual field, first extend the type of the data you're adding the field to in your client schema. In this case we need to extend the `Launch` type, notice how we already defined it in our `typeDefs`:
