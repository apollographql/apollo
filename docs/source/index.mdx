...
import {StandaloneDocsetNav} from 'gatsby-theme-apollo-docs';
...
- [Apollo Graph Manager](https://www.apollographql.com/docs/graph-manager) (formerly Engine), a cloud service that helps you manage, validate, and secure your organization's data graph

- Developer tools that make it even easier to work with Apollo, including extensions for [Chrome](https://apollographql.com/docs/react/features/developer-tooling/#apollo-client-devtools) and [VS Code](https://www.apollographql.com/docs/graph-manager/editor-plugins/)
