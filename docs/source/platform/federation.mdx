...
TODO: Discussing how the gateway picks up changes from the registry
...
```
$ npx apollo@2.15.1-alpha.1 service:check --serviceName launches --endpoint http://localhost:4001/api/graphql --tag current
  ✔ Loading Apollo Project
...
#### Failed composition
```
$ ../apollo-tooling/packages/apollo/bin/run service:check --serviceName launches --endpoint http://localhost:4001/api/graphql --tag current
  ✔ Loading Apollo Project
...
#### Failed usage checks
```
$ ../apollo-tooling/packages/apollo/bin/run service:check --serviceName registry --endpoint http://localhost:4001/api/graphql --engine https://engine-staging-graphql.apollographql.com/api/graphql --tag staging --frontend https://engine-staging.apollographql.com
  ✔ Loading Apollo Project
