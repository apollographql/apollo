...
If your graph is composed using federation, you can also use the `apollo service:check` command to validate individual service changes by providing a service name.
